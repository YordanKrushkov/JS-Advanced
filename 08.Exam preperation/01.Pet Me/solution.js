function solve() {
    ...
    function onAddButton(e) {
        ...
        contactButton.addEventListener('click', onContactButton);
    }
    function onContactButton(e) {
        ...
        takeButton.addEventListener('click', onTakeButton);
    }

    function onTakeButton(e) {
        ...
        newOwner.innerHTML = `New Owner: ${ownerInput.value}`;
        ...
        checkedButton.addEventListener('click', checkedElement)
    }
